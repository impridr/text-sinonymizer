...
В США они говорили о «тревожном явлении» после поездки Путина в Иран.',
            ...
            [
                ...
                ['ru', 'en'],
                'Это стало известно о состоянии первого пациента с оспой в России',
                null
            ],
            [
                'Глава МИД ФРГ раскритиковала Эрдогана за фото с Путиным',
                ['ru', 'en'],
                'Министр иностранных дел FRG раскритиковал Эрдогана за фотографии с Путином',
                null
            ],
            [
